        ...
        var h = function h() {
          ...
          if (s.is("[multiple]")) {
            ...
            if ("auto" == x.css("left") && x.css({
              ...
              top: F
            }), I = F), x.hide(), q.length && (c.first().text() != k.text() && g.addClass("changed"), g.data("jqfs-class", q.data("jqfs-class")), g.addClass(q.data("jqfs-class"))), s.is(":disabled")) return g.addClass("disabled"), !1;
            y.click(function () {
              if (t("div.jq-selectbox").filter(".opened").length && o.onSelectClosed.call(t("div.jq-selectbox").filter(".opened")), s.focus(), !n) {
                var i = t(window),
                    e = T.data("li-height"),
                    r = g.offset().top,
                    l = i.height() - F - (r - i.scrollTop()),
