...
testWebP(function (i) {
  1 == i ? document.querySelector("body").classList.add("webp") : document.querySelector("body").classList.add("no-webp");
}), function (i) {
  "use strict";
  ...
  i.preventDefault(), $(".tab").removeClass("tab--active"), $(".tabs-content").removeClass("tabs-content--active"), $(this).addClass("tab--active"), $($(this).attr("href")).addClass("tabs-content--active");
}), $(".product-tab").on("click", function (i) {
  i.preventDefault(), $(".product-tab").removeClass("product-tab--active"), $(".product-content").removeClass("product-content--active"), $(this).addClass("product-tab--active"), $($(this).attr("href")).addClass("product-content--active");
}), $(".products-item__favorite").on("click", function (i) {
  i.preventDefault(), $(".products-item__favorite").toggleClass("products-item__favorite--active");
});