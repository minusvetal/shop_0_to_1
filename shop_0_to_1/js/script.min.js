...
}), $(".tabs-search__item").on("click", function (i) {
  i.preventDefault(), $(".tabs-search__item").removeClass("tabs-search__item--active"), $(".tabs-search__content-item").removeClass("tabs-search__content-item--active"), $(this).addClass("tabs-search__item--active"), $($(this).attr("href")).addClass("tabs-search__content-item--active");
});